...
function Jobs() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${BASE_URL}/jobs/alljobs?companyID=${companyID}&startDate=${start}&endDate=${end}`
      )
      .then((res) => {
        let data = [];
        ...
        <div className="container mx-auto px-4 sm:px-6 py-8 flex-1 max-w-full overflow-x-hidden">
                    ...
                    <div className="bg-white rounded-xl shadow-xl w-96 max-h-[90vh] p-6 relative overflow-hidden">
                      ...
                      <div className="space-y-2   text-sm text-gray-700">
                        ...
                        <p>
                          ...
                          {new Date(
                            selectedJob.DateIssued
                          ).toLocaleDateString()}
                        </p>
                        <p>
                          <strong>ExTax:</strong>{" "}
                          {selectedJob?.Total?.ExTax ?? "N/A"}
                        </p>
                        <p>
                          <strong>IncTax:</strong>{" "}
                          {selectedJob?.Total?.IncTax ?? "N/A"}
                        </p>
                        <p>
                          <strong>Tax:</strong>{" "}
                          {selectedJob?.Total?.Tax ?? "N/A"}
                        </p>
                      </div>
          ...
          <div className="flex overflow-x-hidden  flex-col sm:flex-row justify-between items-center p-4 bg-gray-50 border-t gap-2 sm:gap-0  ">
            <button
              ...
              className="px-4 py-2 cursor-pointer  bg-[var(--color-primary)] text-white   font-semibold  hover:bg-[#007EA8] rounded disabled:cursor-not-allowed"
            >
              Previous
            </button>
            ...
            <button
              ...
              className="px-7 py-2  bg-[var(--color-primary)] text-white  font-semibold  rounded disabled:cursor-not-allowed cursor-pointer  hover:bg-[#007EA8]"
            >
              Next
            </button>
          </div>
